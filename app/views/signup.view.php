...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= ROOT ?>/niceadmin/<?= ROOT ?>/niceadmin/assets/img/favicon.png" rel="icon">
...
<body>
  ...
  <script src="<?= ROOT ?>/niceadmin/assets/js/main.js<?= time() ?>"></script>
