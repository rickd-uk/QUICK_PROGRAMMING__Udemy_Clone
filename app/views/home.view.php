      ...
      <div class="row g-5">
        <div class="col-lg-4">
          ...
          <div class="post-entry-1 lg">
            ...
            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span><?= get_date($first_row->date) ?></span></div>
            ...
            <?php if (!empty($first_row->user_row)) : ?>
              <div class="d-flex align-items-center author">
                ...
                <div class="name">
                  ...
                  <h3 class="<?= $first_row->user_row->firstname  . ' ' . $first_row->user_row->lastname  ?>"> </h3>
                </div>
              </div>
            <?php endif; ?>
          </div>
              ...
              <?php if (!empty($rows1)) : ?>
                <?php foreach ($rows1 as $row) : ?>
                  <div class="post-entry-1">
                    ...
                    <h2><a href="single-post.html">GREAT</a></h2>
                  </div>
                <?php endforeach; ?>
              <?php endif; ?>
            </div>
