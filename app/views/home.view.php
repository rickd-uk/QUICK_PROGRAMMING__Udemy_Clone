      ...
      <div class="row g-5">
        <div class="col-lg-4">
          ...
          <div class="post-entry-1 lg">
            <a href="single-post.html"><img src="<?= get_image($r->course_image, 'courses') ?>" alt="" class="img-fluid" style="object-fit:cover"></a>
            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
            <h2><a href="single-post.html"><?= esc($r->title) ?></a></h2>
            <p class="mb-4 d-block"><?= esc($r->description)  ?></p>

            <?php if (!empty($r->user_row)) : ?>
              <div class="d-flex align-items-center author">
                <div class="photo"><img src="<?= get_image($r->user_row->image) ?>" alt="" class="img-fluid"></div>
                <div class="name">
                  hello
                  <h3 class="<?= $r->user_row->firstname  . ' ' . $r->user_row->lastname  ?>"> </h3>
                </div>
              </div>
            <?php endif; ?>
          </div>
